...
$messages = $message->getMessagesByUser($_SESSION['user_id']);
?>
...
<head>
    ...
    <title>Customer Inbox - rideCore</title>
        ...
        <?php foreach($messages as $msg): ?>
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <a href="../chat/chat.php?with=<?php echo $msg['sender_id'] == $_SESSION['user_id'] ? $msg['receiver_id'] : $msg['sender_id']; ?>&vehicle_id=<?php echo $msg['vehicle_id']; ?>" 
