                    ...
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <i class="fas fa-map-marker-alt text-danger"></i> <?php echo htmlspecialchars($vehicle['location']); ?><br>
                            ...
                            <div class="card-footer">
                                <a href="book_vehicle.php?id=<?php echo $vehicle['vehicle_id']; ?>&start=<?php echo urlencode($start_date); ?>&end=<?php echo urlencode($end_date); ?>" class="btn btn-primary w-100">
