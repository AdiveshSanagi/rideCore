...
// Check if the vehicle belongs to the current provider
...
$customer->user_id = $booking->customer_id;
$customer->getById();
            ...
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="update_booking.php?id=<?php echo $booking->booking_id; ?>&action=accept" class="btn btn-success">
                            <i class="fas fa-check"></i> Accept
                        </a>
                        <a href="update_booking.php?id=<?php echo $booking->booking_id; ?>&action=reject" class="btn btn-danger">
                            <i class="fas fa-times"></i> Reject
                        </a>
                        <?php endif; ?>
                        <?php if($booking->status == 'accepted'): ?>
                        <a href="update_booking.php?id=<?php echo $booking->booking_id; ?>&action=complete" class="btn btn-primary">
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                       ...
                       <!-- <a href="../chat/chat.php?user=<?php echo $customer->user_id; ?>&booking=<?php echo $booking->booking_id; ?>" class="btn btn-outline-primary w-100">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="vehicles.php" class="btn btn-outline-secondary w-100">
