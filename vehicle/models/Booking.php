...
class Booking {
   ...
   public function create() {
    $query = "INSERT INTO bookings 
                (customer_id, vehicle_id, vehicle_name, start_time, end_time, status, pickup_location, dropoff_location, total_amount, created_at)
              VALUES 
                (:customer_id, :vehicle_id, :vehicle_name, :start_time, :end_time, :status, :pickup_location, :dropoff_location, :total_amount, NOW())";

    $stmt = $this->conn->prepare($query);

    // Normalize status to lowercase
    $normalized_status = strtolower($this->status);
    ...
    $stmt->bindParam(':status', $normalized_status);
    ...
    $status = strtolower(htmlspecialchars(strip_tags($status)));
